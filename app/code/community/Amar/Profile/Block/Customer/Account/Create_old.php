...
(
    ...
    public function getAttributeFrontendHtmlControl($attributeCode)
    {
        ...
        $html  ='<label for="'.$this->_idPrefix.$attribute->getAttributeCode().'" class="'.(($attribute->getIsRequired() == false)?"col-sm-4 control-label":"").'">';
        ...
        {
            $html.='<textarea cols="15" rows="2" class="'.$attribute->getValidationRules().' '.(($attribute->getIsRequired() == true)?"required-entry":"").' form-control" name="'.$this->_namePrefix.$attribute->getAttributeCode().$this->_nameSufix.'" id="'.$this->_idPrefix.$attribute->getAttributeCode().'">'.(($this->_customerData[$attribute->getAttributeCode()] == "")?$attribute->getDefaultValue():$this->_customerData[$attribute->getAttributeCode()]).'</textarea>';
        }
        elseif($attribute->getFrontendInput() == "text")
        {
            $html .='<input type="text" class="'.$attribute->getValidationRules().' '.(($attribute->getIsRequired() == true)?"required-entry":"").' form-control" value="'.(($this->_customerData[$attribute->getAttributeCode()] == "")?$attribute->getDefaultValue():$this->_customerData[$attribute->getAttributeCode()]).'" name="'.$this->_namePrefix.$attribute->getAttributeCode().$this->_nameSufix.'" id="'.$this->_idPrefix.$attribute->getAttributeCode().'">';
        }
        $html .='</div>';
